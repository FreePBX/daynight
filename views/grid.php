...
$daynightcodes = $daynightcodes ?: [];
?>
<div id="toolbar-all">
	<a class="btn btn-primary" href="?display=daynight&amp;view=form"><i class="fa fa-plus"></i>
		<?php echo _("Add") ?>
	</a>
</div>
<table id="daynightgrid" data-toolbar="#toolbar-all" data-maintain-selected="true" data-show-columns="true"
	data-show-toggle="true" data-toggle="table" data-pagination="true" data-search="true" class="table table-striped">
	<thead>
		<tr>
			<th data-sortable="true">
				<?php echo _("Feature Code") ?>
			</th>
			<th data-sortable="true">
